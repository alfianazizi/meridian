...
export const config = {
  ...
  llm: {
    ...
    screeningMaxSteps: Number(u.screeningMaxSteps ?? 8),
    managementMaxSteps: Number(u.managementMaxSteps ?? 6),
    shadowScreeningEnabled: u.shadowScreeningEnabled ?? false,
    shadowScreeningTimeoutMs: Number(u.shadowScreeningTimeoutMs ?? 90000),
    shadowScreeningKeyCommand: typeof u.shadowScreeningKeyCommand === "string" ? u.shadowScreeningKeyCommand : "",
